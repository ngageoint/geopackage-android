...
Pull from the [Maven Central Repository](http://search.maven.org/#artifactdetails|mil.nga.geopackage|geopackage-android|6.0.2|aar) (AAR, POM, Source, Javadoc)

    api 'mil.nga.geopackage:geopackage-android:6.0.2'
