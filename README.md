...
Pull from the [Maven Central Repository](http://search.maven.org/#artifactdetails|mil.nga.geopackage|geopackage-android|3.0.1|aar) (AAR, POM, Source, Javadoc)

    compile "mil.nga.geopackage:geopackage-android:3.0.1"
