...
## Maintenace Mode
The GeoPackage Android library is in maintenance mode. No further major features or updates are planned.
...
Pull from the [Maven Central Repository](http://search.maven.org/#artifactdetails|mil.nga.geopackage|geopackage-android|6.7.4|aar) (AAR, POM, Source, Javadoc)
