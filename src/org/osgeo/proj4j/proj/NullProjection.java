...
/**
 * A projection which does nothing. Use this for drawing non-geographical
 * overlays.
 */
public class NullProjection extends Projection
{
	 ...
	 * if ( t != null ) t.createTransformedShape( path ); return path; }
	 */
	
	// FIXME: requires awt
	/*
	 * public Shape getBoundingShape() { return null; }
	 */
