...
public class GoogleMapShapeConverter {
     ...
     * @return
     */
    public static mil.nga.geopackage.geom.map.MultiPolygon addPolygonsToMap(
            GoogleMap map, MultiPolygonOptions polygons) {
        mil.nga.geopackage.geom.map.MultiPolygon multiPolygon = new mil.nga.geopackage.geom.map.MultiPolygon();
            ...
            case MULTIPOLYGON:
                switch (shape.getShapeType()) {
                    case MULTI_POLYGON_OPTIONS:
                        ...
                        break;
                    case MULTI_POLYGON:
                        mil.nga.geopackage.geom.map.MultiPolygon multiPolygon = (mil.nga.geopackage.geom.map.MultiPolygon) shapeObject;
